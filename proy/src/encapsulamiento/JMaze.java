...
public class JMaze {
	...
	public boolean isPacManAt(int row, int column) {
		return this.getMatrix()[row][column] != JMaze.FOOD && this.getMatrix()[row][column] != JMaze.EMPTY; 
	}
	
	public boolean isPacManLookingDown() {
		return this.getMatrix()[this.getActualRow()][this.getActualColumn()] == JMaze.PACMAN_DOWN;
	}
	
	public boolean isPacManLookingUp() {
		return this.getMatrix()[this.getActualRow()][this.getActualColumn()] == JMaze.PACMAN_UP;
	}

	public boolean isPacManLookingLeft() {
		return this.getMatrix()[this.getActualRow()][this.getActualColumn()] == JMaze.PACMAN_LEFT;
	}
	
	public boolean isPacManLookingRight() {
		return this.getMatrix()[this.getActualRow()][this.getActualColumn()] == JMaze.PACMAN_RIGHT;
	}
	
	public boolean isEmptyAt(int row, int column) {
		return this.getMatrix()[row][column] == JMaze.EMPTY;
	}
	
	public void pacManDown() {
		this.getMatrix()[this.getActualRow()][this.getActualColumn()] = JMaze.PACMAN_DOWN;
	}
	...
	public void pacManLeft() {
		this.getMatrix()[this.getActualRow()][this.getActualColumn()] = JMaze.PACMAN_LEFT;
	}
	
	public void pacManRight() {
		this.getMatrix()[this.getActualRow()][this.getActualColumn()] = JMaze.PACMAN_RIGHT;
	}
	...
	public void tick() {
		...
		this.getMatrix()[oldRow][oldColumn] = JMaze.EMPTY;
	}
